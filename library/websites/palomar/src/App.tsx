...
export default function App() {
  return (
    <div className="font-helvetica-neue text-brand-dark antialiased">
      <Navbar />
      <Hero />
    </div>
  );
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="relative flex items-center h-16 md:h-20">
            ...
            <button
              ...
              className="md:hidden ml-auto z-50 w-10 h-10 relative flex items-center justify-center focus:outline-hidden"
