    ...
    <>
      <nav className="w-full max-w-[1800px] mx-auto px-5 sm:px-8 md:px-[82px] pt-[20px] sm:pt-[30px] flex items-center justify-between relative z-50">
        ...
        <Animate delay={100} direction="down" className="hidden lg:block">
          <div className="h-[52px] px-6 flex items-center gap-[30px] bg-[rgba(10,7,7,0.35)] rounded-[11px] backdrop-blur-[17px] border border-white/10">
            <button
              type="button"
              className="flex items-center gap-[5px] text-white/80 text-[14px] font-[450] leading-[14px] hover:text-white transition-colors cursor-pointer"
            >
              <span>Platform</span>
              <ChevronDown className="w-[10px] h-[10px] opacity-80" />
            </button>
            {['Pricing', 'Resources', 'Blog'].map((item) => (
              <span
                key={item}
        ...
        <Animate delay={200} direction="down" className="hidden lg:block">
          <div className="h-[52px] p-[3px] bg-[rgba(0,0,0,0.35)] rounded-[13px] backdrop-blur-[17px] flex items-center gap-[5px] border border-white/10">
            <button
              type="button"
              onClick={() => alert('Opening Quantex portal login...')}
              className="h-[46px] px-6 rounded-[11px] text-white text-[14px] font-[450] leading-[14px] hover:bg-white/5 transition-colors cursor-pointer"
            >
              Login
            </button>
            <button
              type="button"
              onClick={() => alert('Initiating demo scheduling...')}
              className="h-[46px] px-6 bg-[#E9E9E9] rounded-[11px] text-[#0A0707] text-[14px] font-[450] leading-[14px] hover:bg-white transition-colors cursor-pointer"
            >
              Book a demo
            </button>
          </div>
        ...
        <Animate delay={100} direction="down" className="lg:hidden">
          <button
            type="button"
            className="w-[44px] h-[44px] flex items-center justify-center rounded-[11px] bg-[rgba(10,7,7,0.35)] backdrop-blur-[17px] transition-colors hover:bg-white/10 cursor-pointer border border-white/10"
        ...
        >
          ...
          >
            <button
              ...
              className="w-full h-[50px] bg-[#E9E9E9] rounded-[12px] text-[#0A0707] text-[15px] font-[450] transition-colors hover:bg-white cursor-pointer"
            >
              Book a demo
            </button>
            <button
              ...
              className="w-full h-[50px] rounded-[12px] border border-white/30 text-white text-[15px] font-[450] transition-colors hover:bg-white/5 cursor-pointer"
            >
              Login
            </button>
          </div>
              ...
              <Animate delay={700} direction="up">
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <button
                    ...
                    className="h-[46px] sm:h-[51px] px-5 sm:px-[27px] bg-[#E9E9E9] rounded-[12px] text-[#0A0707] text-[14px] sm:text-[15.5px] font-[450] leading-[15.5px] transition-opacity hover:opacity-90 cursor-pointer"
                  >
                    Book a demo
                  </button>
                  <button
                    type="button"
                    onClick={() => alert('Connecting to Quantex engineering team...')}
                    className="h-[46px] sm:h-[51px] px-5 sm:px-[27px] rounded-[12px] border border-white text-white text-[14px] sm:text-[15.5px] font-[450] leading-[15.5px] transition-opacity hover:opacity-80 cursor-pointer"
                  >
                    Talk with the team
                  </button>
                </div>
