...
(() => {
  ...
  const TYPE_ORDER = ["all", "website", "brand", "logo", "system", "component"];
  ...
  function countByType() {
    const counts = { website: 0, brand: 0, logo: 0, system: 0, component: 0 };
    getItems().forEach((t) => {
  ...
  function renderStats() {
    ...
    if (els.statComponents) els.statComponents.textContent = String(counts.component || 0);
  }
